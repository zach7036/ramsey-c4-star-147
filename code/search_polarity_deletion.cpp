// Heuristic discovery search for a 24-point deletion from ER(13).
//
...
// discovery route.  With libstdc++ and the archived command (seed 555), it
// typically finds a valid deletion in a few seconds on one CPU core.
//
// Build:
//   g++ -O3 -std=c++17 search_polarity_deletion.cpp -o search_polarity_deletion
// Run:
//   ./search_polarity_deletion 13 24 12 555 20000000 replay.json 1
